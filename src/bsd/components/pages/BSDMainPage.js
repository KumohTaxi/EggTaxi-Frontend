    ...
    return(
        <div className='BSDMainPage'>
            <div className='main_header'>
                ...
                <img src='/icons/bsd_my_icon.png'/>
            </div>
            <div className='main_body'>
                <div>
                    <div onClick={()=>navigate(`/bsd/map`)}>
                        <img src='/icons/bsd_loc_icon.png'/>
                        <div>등록 물품 조회</div>
                    </div>
                    <div>
                        <div onClick={()=>navigate(`/bsd/Registration/lost`)}>
                            <img src='/icons/bsd_lost_icon.png'/>
                            <div>
                                <div>분실물</div>
                                <div>등록</div>
                            </div>
                        ...
                        <div onClick={()=>navigate(`/bsd/Registration/find`)}>
                            <img src='/icons/bsd_get_icon.png'/>
                            <div>
                                <div>습득물</div>
                                <div>등록</div>
                            </div>
                    ...
                    <div onClick={()=>navigate(`/bsd/chating`)}>
                        <img src='/icons/bsd_chat_icon.png'/>
                        <div>채팅</div>
                    </div>
                </div>
            </div>
